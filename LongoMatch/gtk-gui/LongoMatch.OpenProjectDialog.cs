...
namespace LongoMatch {
    ...
    public partial class OpenProjectDialog {
        ...
        private LongoMatch.FileDataListWidget filedatalistwidget;
        ...
        protected virtual void Build() {
            ...
            // Widget LongoMatch.OpenProjectDialog
            this.Name = "LongoMatch.OpenProjectDialog";
            this.Title = Mono.Unix.Catalog.GetString("Open Project");
            this.WindowPosition = ((Gtk.WindowPosition)(4));
            this.HasSeparator = false;
            // Internal child LongoMatch.OpenProjectDialog.VBox
            Gtk.VBox w1 = this.VBox;
            w1.Name = "dialog1_VBox";
            w1.BorderWidth = ((uint)(2));
            // Container child dialog1_VBox.Gtk.Box+BoxChild
            this.filedatalistwidget = new LongoMatch.FileDataListWidget();
            ...
            w2.Position = 0;
            // Internal child LongoMatch.OpenProjectDialog.ActionArea
            ...
            this.Show();
            this.filedatalistwidget.FileDataSelectedEvent += new LongoMatch.FileDataSelectedHandler(this.OnFiledatalistwidgetFileDataSelectedEvent);
        }
    }
}
