...
#region Autogenerated code
	public  class BaconVideoWidget :GLib.Object ,IPlayer{
		...
		[Obsolete]
		protected BaconVideoWidget(GLib.GType gtype) : base(gtype) {}
		public BaconVideoWidget(IntPtr raw) : base(raw) {}

		[DllImport("libcesarplayer.dll")]
		static extern IntPtr bacon_video_widget_new(int width, int height, int type, IntPtr error);

		public BaconVideoWidget (int width, int height, CesarPlayer.BvwUseType type, string error) : base (IntPtr.Zero)
		{
			if (GetType () != typeof (BaconVideoWidget)) {
				throw new InvalidOperationException ("Can't override this constructor.");
			}
			Raw = bacon_video_widget_new(width, height, (int) type, GLib.Marshaller.StringToPtrGStrdup(error));
		}
		...
		{
			try {
				BaconVideoWidget bvw_managed = GLib.Object.GetObject (bvw, false) as BaconVideoWidget;
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideStateChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideGotRedirect")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideSegmentDone")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideEos")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideError")]
		...
		[GLib.Signal("error")]
		protected event CesarPlayer.ErrorHandler Error {
			add {
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideBuffering")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideChannelsChange")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideGotMetadata")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideTick")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideTitleChange")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(CesarPlayer.BaconVideoWidget), ConnectionMethod="OverrideGotDuration")]
		...
		[DllImport("libcesarplayer.dll")]
		static extern bool bacon_video_widget_open(IntPtr raw, IntPtr mrl, IntPtr err);

		public bool Open(string mrl, string err) {
			IntPtr native_mrl = GLib.Marshaller.StringToPtrGStrdup (mrl);
			bool raw_ret = bacon_video_widget_open(Handle, native_mrl, GLib.Marshaller.StringToPtrGStrdup(err));
			bool ret = raw_ret;
