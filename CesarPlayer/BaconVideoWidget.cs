...
#region Autogenerated code
	public  class GstPlayer :GLib.Object ,IPlayer{
		...
		public GstPlayer (int width, int height, CesarPlayer.BvwUseType type, out string error) : base (IntPtr.Zero)
		{
			...
			InitBackend(null);
			Raw = bacon_video_widget_new(width, height, (int) type, out errorMessage);
			error = GLib.Marshaller.PtrToStringGFree(errorMessage);
