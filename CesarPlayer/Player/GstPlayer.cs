...
#region Autogenerated code
	public  class GstPlayer :GLib.Object ,IPlayer, IMetadataReader, IFramesCapturer{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void ErrorVMDelegate (IntPtr gst, IntPtr message);

		static ErrorVMDelegate ErrorVMCallback;

		static void error_cb (IntPtr gst, IntPtr message)
		{
			try {
				GstPlayer gst_managed = GLib.Object.GetObject (gst, false) as GstPlayer;
				gst_managed.OnError (GLib.Marshaller.Utf8PtrToString (message));
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		}
		...
		public bool Open(string mrl) {
			...
			if (Environment.OSVersion.Platform == PlatformID.Win32NT)
				native_mrl = GLib.Marshaller.StringToPtrGStrdup ("file:///"+mrl);
			else
				native_mrl = GLib.Marshaller.StringToPtrGStrdup ("file://"+mrl);
			IntPtr error = IntPtr.Zero;
