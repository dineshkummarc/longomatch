...
#region Autogenerated code
	public  class GstPlayer :GLib.Object ,LongoMatch.Video.IPlayer, IMetadataReader{
		...
		public GstPlayer (int width, int height, LongoMatch.Video.UseType type) : base (IntPtr.Zero)
		{
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideStateChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideGotRedirect")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideSegmentDone")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideEos")]
		...
		{
			LongoMatch.Video.Handlers.ErrorArgs args = new LongoMatch.Video.Handlers.ErrorArgs ();
			try {
				GLib.Signal sig = ((GCHandle) gch).Target as GLib.Signal;
				if (sig == null)
					throw new Exception("Unknown signal GC handle received " + gch);
				...
				args.Args[1] = arg2;
				args.Args[2] = arg3;
				LongoMatch.Video.Handlers.ErrorHandler handler = (LongoMatch.Video.Handlers.ErrorHandler) sig.Handler;
				handler (GLib.Object.GetObject (arg0), args);
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideError")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideBuffering")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideChannelsChange")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideGotMetadata")]
		...
		{
			LongoMatch.Video.Handlers.TickArgs args = new LongoMatch.Video.Handlers.TickArgs ();
			try {
				GLib.Signal sig = ((GCHandle) gch).Target as GLib.Signal;
				if (sig == null)
					throw new Exception("Unknown signal GC handle received " + gch);
				...
				args.Args[2] = arg3;
				args.Args[3] = arg4;
				LongoMatch.Video.Handlers.TickHandler handler = (LongoMatch.Video.Handlers.TickHandler) sig.Handler;
				handler (GLib.Object.GetObject (arg0), args);
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideTick")]
		...
		{
			LongoMatch.Video.TitleChangeArgs args = new LongoMatch.Video.TitleChangeArgs ();
			try {
				GLib.Signal sig = ((GCHandle) gch).Target as GLib.Signal;
				if (sig == null)
					throw new Exception("Unknown signal GC handle received " + gch);
				...
				args.Args = new object[1];
				args.Args[0] = GLib.Marshaller.Utf8PtrToString (arg1);
				LongoMatch.Video.TitleChangeHandler handler = (LongoMatch.Video.TitleChangeHandler) sig.Handler;
				handler (GLib.Object.GetObject (arg0), args);
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideTitleChange")]
		...
		public event LongoMatch.Video.TitleChangeHandler TitleChange {
			add {
		...
		[GLib.DefaultSignalHandler(Type=typeof(LongoMatch.Video.GstPlayer), ConnectionMethod="OverrideGotDuration")]
