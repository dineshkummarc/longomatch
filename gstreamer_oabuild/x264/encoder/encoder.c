...
static int x264_validate_parameters( x264_t *h )
{
    ...
    {
		x264_log( h, X264_LOG_ERROR, "no ratecontrol method specified. Value %d\n", h->param.rc.i_rc_method );
        return -1;
    }
...
x264_t *x264_encoder_open   (x264_param_t * param)
{
	...
	/*x264_log( h, X264_LOG_WARNING, "rc_method:%d\n",h->param.rc.i_rc_method);
	x264_log( h, X264_LOG_WARNING, "stat_read:%d\n",h->param.rc.b_stat_read);
	x264_log( h, X264_LOG_WARNING, "stat_write:%d\n",h->param.rc.b_stat_write );	
	x264_log( h, X264_LOG_WARNING, "ip_factor:%d\n",h->param.rc.f_ip_factor);	
	x264_log( h, X264_LOG_WARNING, "pb_factor:%d\n",h->param.rc.f_pb_factor );
	x264_log( h, X264_LOG_WARNING, "qp_constant:%d\n",h->param.rc.i_qp_constant );
	x264_log( h, X264_LOG_WARNING, "rf_constant:%d\n",h->param.rc.f_rf_constant );	
	x264_log( h, X264_LOG_WARNING, "vbv_max_bitrate:%d\n",h->param.rc.i_vbv_max_bitrate );
    x264_log( h, X264_LOG_WARNING, "vbv_buffer_size:%d\n",h->param.rc.i_vbv_buffer_size);
	x264_log( h, X264_LOG_WARNING, "qp_min:%d\n",h->param.rc.i_qp_min );	
	x264_log( h, X264_LOG_WARNING, "qp_max:%d\n",h->param.rc.i_qp_max );
	x264_log( h, X264_LOG_WARNING, "qp_step:%d\n",h->param.rc.i_qp_step);*/
